...
3. Continuar usando a ponte n8n já existente ([[Automacao Comercial Yalt|yalt-revenue-os]] memória externa ao vault) — que já sincroniza status de lead para o CRM, mas está **inativa** por falta da credencial `CRM Yalt API` (httpBearerAuth).
