...
const SKIP_FOLDERS = ["90 Arquivo", ".trash", "Excalidraw", "70 Sistema/Templates", "70 Sistema/Automacao/n8n-selfhost", ".obsidian", ".claude", ".claudian", ".git", "node_modules", "raw", "logs", "pixel-agents", "Jarvis", "output/comercial"];
